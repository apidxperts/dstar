...
HomeOneComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({ type: HomeOneComponent, selectors: [["app-home-one"]], decls: 31, vars: 0, consts: [[1, "bg-1"], [1, "d-table"], [1, "d-table-cell"], ["id", "stars"], ["id", "stars2"], ["id", "stars3"], [1, "container"], ["id", "title"], [1, "main-banner-text"], [1, "btn", "btn-primary", 3, "click"]], template: function HomeOneComponent_Template(rf, ctx) { if (rf & 1) {
